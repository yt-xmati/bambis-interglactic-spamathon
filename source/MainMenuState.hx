...
class MainMenuState extends MusicBeatState
{
	...
	public static var modVersion:String = '0.6'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, ClientPrefs.getResolution()[1] - 64, 0, "VS Bambi: Interglactic Spamathon v" + modVersion, 12);
